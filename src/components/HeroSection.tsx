...
const HeroSection = () => {
  ...
  return <section ref={sectionRef} className="relative min-h-screen flex items-center pt-20 pb-52 overflow-hidden">
      ...
      }} className="absolute inset-0 bg-gradient-to-r from-luxury-black/95 to-luxury-charcoal/90 z-10 rounded-none"></div>
      ...
      <div className="container relative z-20">
        <div className="max-w-3xl mb-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in-delay-3">
            <Button size="lg" variant="default" className="bg-luxury-gold text-luxury-dark rounded-sm px-8 hover:bg-luxury-khaki hover:text-luxury-dark hover:scale-105 transition-all duration-300 group" asChild>
              <Link to="/properties">
