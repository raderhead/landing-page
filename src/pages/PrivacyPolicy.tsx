      ...
      <div className="min-h-screen bg-luxury-dark">
        ...
        <main className="container py-16 px-4 md:px-8">
          <div className="max-w-4xl mx-auto bg-luxury-black p-6 md:p-10 rounded-md border border-luxury-khaki/10">
            ...
            <div className="prose prose-invert max-w-none space-y-6 text-luxury-khaki">
              <p className="text-lg">Last Updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
              
              <section className="mt-8">
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Introduction</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Collection of Your Information</h2>
                <p>
                ...
                <h3 className="text-xl font-semibold text-white mt-6 mb-2">Derivative Data</h3>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Use of Your Information</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Disclosure of Your Information</h2>
                <p>
                  We may share information we have collected about you in certain situations. Your information may be disclosed as follows:
                </p>
                
                <h3 className="text-xl font-semibold text-white mt-6 mb-2">By Law or to Protect Rights</h3>
                <p>
                  If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation.
                </p>
                
                <h3 className="text-xl font-semibold text-white mt-6 mb-2">Business Partners</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold text-white mt-6 mb-2">Third-Party Service Providers</h3>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Security of Your Information</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Cookies and Web Beacons</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Third-Party Websites</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Your Rights Regarding Your Information</h2>
                <h3 className="text-xl font-semibold text-white mt-6 mb-2">Access and Correction</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold text-white mt-6 mb-2">Email Marketing</h3>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-luxury-gold mb-4">Contact Us</h2>
                <p>
